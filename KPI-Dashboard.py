...
if input_method == "Datei-Upload":
    ...
    if df is not None:
        ...
        color_map_provider_global = {prov: colors_provider[i % len(colors_provider)] for i, prov in
                                     enumerate(providers_all)}
        ...
        if len(date_range) != 2:
            ...
            selected_standorte = st.sidebar.multiselect(
                ...
                options=standorte,
                default=standorte  # Standard: Alle ausgewählt
            )
            ...
            if df_filtered.empty:
                ...
                with portfolio_col2:
                    ...
                    prov_trend_all['Prozent'] = prov_trend_all.groupby('Monat')['Anzahl'].transform(
                        lambda x: x / x.sum() * 100)
                ...
                for standort in selected_standorte:
                    ...
                    with auth_col:
                        ...
                        auth_trend['Prozent'] = auth_trend.groupby('Beendet')['Anzahl'].transform(
                            lambda x: x / x.sum() * 100)
                    ...
                    with prov_col:
                        ...
                        prov_trend['Prozent'] = prov_trend.groupby('Monat')['Anzahl'].transform(
                            lambda x: x / x.sum() * 100)
